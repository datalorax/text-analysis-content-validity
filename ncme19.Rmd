...
According to @kane06, content validity is necessarily based on subjective judgments. Because of this, establishing content validity lacks the objectivity of other sources of validity evidence (such as criterion-related evidence) and is therefore more subject to confirmation bias. Alignment studies, then, can be not only time consuming and cost intensive, but also subjective in ways that may threaten the content validity of assessments.
