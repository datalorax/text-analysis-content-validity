...
cover the content represented in the standards). For the conference paper, we
also plan to provide much more detail about the modeling, its strengths and
limitations, and a more in-depth illustrations the results of our application. 
