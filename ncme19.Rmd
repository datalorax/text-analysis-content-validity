...
abstract: |
  ...
  paper, we propose an alternative approach that builds upon traditional methods 
  for alignment but leverages the use of text-based machine learning procedures,
  ...
  content-related validity evidence. We discuss this approach, and show how
  visualizations can be used to evaluate to overall coverage of the content 
